...
return {
    ...
    },
    {
        ...
        opts = function(_, opts)
            ...
            vim.api.nvim_set_hl(0, "CurSearch",       { bg = "#C71275", fg = "#FFFFFF", bold = true })
            vim.api.nvim_set_hl(0, "IncSearch",       { bg = "#C71275", fg = "#FFFFFF", bold = true })
            vim.api.nvim_set_hl(0, "CursorLine",      { bg = "#1A1D2A" })
            vim.api.nvim_set_hl(0, "CursorLineNr",    { fg = "#C71275", bold = true })
            ...
            vim.api.nvim_set_hl(0, "PmenuThumb",      { bg = "#C71275" })
